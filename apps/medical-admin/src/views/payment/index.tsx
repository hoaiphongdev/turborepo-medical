...
// ** Step Components
import StepPayment from 'views/payment/StepPayment'
import StepConfirmation from 'views/payment/StepConfirmation'
...
type PaymentWizzardProps = {
  invoiceData: any
}

const PaymentWizzard = ({ invoiceData }: PaymentWizzardProps) => {
  // ** States
  ...
  const getStepContent = (step: number) => {
    switch (step) {
      case 0:
        return <StepPayment invoiceData={invoiceData} handleNext={handleNext} />
      case 1:
        return <StepConfirmation invoiceData={invoiceData} />
      default:
        return <StepPayment invoiceData={invoiceData} handleNext={handleNext} />
    }
  }
